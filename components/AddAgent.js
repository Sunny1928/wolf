export class AddAgent extends HTMLElement{ 
  constructor(test = 1){
    ...
    html+= `
          <button class="addSimpleAgent text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 font-medium rounded-lg text-sm px-4 py-2 text-center m-1">Simple Agent</button>
          ...
          <button class="addSummaryIntelligentAgent text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 font-medium rounded-lg text-sm px-4 py-2 text-center m-1">Summary Intelligent Agent</button>
          <button class="addSummaryMemmoryAgent text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 font-medium rounded-lg text-sm px-4 py-2 text-center m-1">Summary Memory Agent</button>
          </div>
      </div>
    </div>
  </div>`
